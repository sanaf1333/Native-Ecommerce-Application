...
const EditProduct = () => {
  ...
  return (
    ...
    <View>
      ...
      <TextInput onChangeText={text => setTitle(text)} value={title} placeholder="Title" style={styles.button} />
      <Text style={styles.text}>Price</Text>
      <TextInput onChangeText={handlePriceChange} value={price} placeholder="Price" style={styles.button} keyboardType="numeric" />
      <View>
      ...
      <TextInput onChangeText={description => setDescription(description)} value={description} multiline
        numberOfLines={6} placeholder="Description" style={styles.button} />
